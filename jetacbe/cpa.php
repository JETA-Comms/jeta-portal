       ...
       <?php include "cbesidebar.php"; ?>
        ...
        <div class="main">
            ...
            <div class="questions-main">
                <?php
                    $result = mysqli_query($conn, "SELECT * FROM cpa WHERE id= '$id' ");
                ...
                <div class="questions">
                    ...
                    <div class="questionBtns">
                        ...
                        <?php
                            ...
                            $prevsql= "SELECT * FROM cpa WHERE id<$id order by id DESC"; //I used figured one to text this and it gave me single answer,
                            // then I proceed to declare the variable of $id and also define the array key of id in the get.
                            $nextsql= "SELECT * FROM cpa WHERE id>$id order by id ASC";

                            // previous button
                            $previous = mysqli_query($conn, $prevsql);
                            if($row = mysqli_fetch_array($previous)){
                                echo '<a style="text-decoration: none;" href="cpa.php?id='.$row['id'].'">
                    ...
                    <?php foreach ($subject as $english): ?>
                        ...
                        <!-- <div class="questionNum">
                            <ol>
                                ...
                                <a style="text-decoration: none;" href="cpa.php?id=<?php echo $english["id"]; ?>"><div class="questionNum"><?php echo $english["id"]; ?></div> </a>
